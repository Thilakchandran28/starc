...
const AssessmentRow: React.FC<AssessmentRowProps> = ({ assessment }) => {
  ...
  return (
    <div className="2xl:grid grid-flow-col 2xl:w-[650px] 2xl:text-[12px]  3xl:w-[900px] 3xl:text-[15px]  lg:flex lg:text-[10px] lg:w-[600px]  py-3 border-b border-gray-100 last:border-b-0">
      ...
      <div className="px-4 whitespace-nowrap  flex justify-items-start ">
        {getStatusDisplay(assessment.status)}
      </div>
      <div className="text-gray-500 text-sm pl-4 whitespace-nowrap text-right  flex justify-center lg:text-[10px]">
        {assessment.date}
      </div>
    </div>
  );
