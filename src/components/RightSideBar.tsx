  ...
  return (
    ...
    // <div className="  px-8 lg:h-[80vh] lg:w-[30vw] fixed top-32 right-10">
      ...
      <div className='flex justify-center  '>
          <div className="bg-[#8A63FF] text-white lg:p-2 xl:p-4  pt-4 rounded-lg shadow-md lg:w-[300px] xl:w-[323px]  2xl:w-[343px] 3xl:h-[243px] flex flex-col justify-between col-span-1 bg-[url('../Assets/cardaward.png')] bg-cover bg-center">
