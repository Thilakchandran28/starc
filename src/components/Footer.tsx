import Instas from "../Assets/Instas.png";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-11">
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between text-gray-600">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="#" className="text-gray-600 hover:text-gray-900 w-full h-full"><img src={Instas} alt="Instagram" className="h-6 w-6" /></a>
            <a href="#" className="text-gray-600 hover:text-gray-900 w-full h-full"><img src={Shares}alt="Telegram" className="h-6 w-6" /></a>
            <a href="#" className="text-gray-600 hover:text-gray-900 w-full h-full"><img src={Musics} alt="TikTok" className="h-6 w-6" /></a>
            <a href="#" className="text-gray-600 hover:text-gray-900 w-full h-full"><img src={yt} alt="YouTube" className="h-6 w-6" /></a>
          </div>
        </div>
      </div>
    </footer>
