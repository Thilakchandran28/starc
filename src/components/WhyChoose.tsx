  ...
  return (
    <section className="py-10 bg-white overflow-hidden relative"> {/* Added relative and overflow-hidden for circles */}
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0 ">
        <div className="relative w-[40%]  aspect-square"> {/* Adjust w and max-w for size */}
      ...
      <div className="w-[70%] mx-auto px-4 sm:px-6 lg:px-8 pb-2 h-[100%] relative z-10"> {/* z-10 to bring content above circles */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center w-[100%]  h-[100%]">
          ...
          <div className="flex flex-col gap-6  h-full  justify-end pb-[20%] items-end "> {/* items-end to push cards to the right (closer to center) */}
            {/* Courses Card */}
            <div className="w-[70%] grid grid-cols-1 bg-white rounded-3xl p-2 shadow-2xl lg:text-xs xl:text-sm 2xl:text-base"> {/* Added max-w for consistency */}
              ...
              <h3 className="font-semibold lg:text-xs xl:text-sm 2xl:text-base text-gray-900 mb-2 text-center">Courses</h3>
              <p className="lg:text-xs xl:text-sm 2xl:text-base text-gray-600 mb-4 text-center">Lorem ipsum dolor sit amet<br></br> consectetur.</p>
              <div className="flex items-center justify-center">
                <button className="bg-purple-600 flex items-center align-center text-white px-4 py-2 rounded-3xl  lg:text-xs xl:text-sm 2xl:text-base hover:bg-purple-700">
                  Courses
                </button>
              </div>
            </div>
            ...
            <div className="w-[70%] bg-white rounded-3xl p-1 shadow-2xl  mt-6"> {/* self-start for alignment, mt-6 for vertical spacing */}
              <div className="flex items-center  gap-1 p-1 ">
                ...
                <div >
                  <span className="lg:text-xs xl:text-sm 2xl:text-base font-semibold text-gray-900 text-left">100K+</span>
                  <p className="lg:text-xs xl:text-sm 2xl:text-base text-gray-600">Lorem ipsum dolor sit amet <br></br> consectetur.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-start h-full pt-[20%] gap-6 items-start "> {/* items-start to push cards to the left (closer to center) */}
            ...
            <div className="w-[70%] bg-white rounded-xl p-6 shadow-2xl  mb-6 flex "> {/* self-end for alignment, mb-6 for vertical spacing */}
              <div className="p-1 flex justify-center items-center   rounded-lg w-fit">
                {/* <MessageSquare className="w-6 h-6 text-blue-600" /> */}
                <img src={opp} className="lg:w-7 h-7" />
              </div>
              <div className="flex justify-center items-center">
                <h3 className="font-semibold  text-gray-900  lg:text-xs xl:text-sm 2xl:text-base">Opportunities</h3>
              </div>

            </div>

            {/* Learning Card */}
            <div className="w-[70%] bg-white rounded-2xl p-6 shadow-2xl "> {/* Added max-w for consistency */}
              ...
              <h3 className="font-semibold  text-gray-900 mb-2 text-center lg:text-xs xl:text-sm 2xl:text-base">Learning</h3>
              <p className=" text-gray-600 text-center lg:text-xs xl:text-sm 2xl:text-base">Lorem ipsum dolor sit amet<br></br>consectetur.</p>
