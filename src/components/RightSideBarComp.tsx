    ...
    <div className=" lg:h-[80vh] lg:w-[230px] xl:h-[80vh] xl:w-[260px] 2xl:h-[80vh] 2xl:w-[330px] 3xl:w-[380px] 3xl:h-[80vh]">
      ...
      >
        <div className="flex justify-between items-center mb-4 w-full ">
          ...
          <select className="text-[#8A63FF] border border-[#8A63FF] rounded-md px-1 py-1 lg:w-[57px] lg:h-[18px] xl:w-[67px] xl:h-[22px] 2xl:w-[77px] 2xl:h-[27px] lg:text-[7px] xl:text-[9px] 2xl:text-[11px] 3xl:text-[12px]">
