      ...
      <section className="relative bg-white overflow-hidden flex lg:flex-row px-10 lg:px-20 lg:py-24">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center pl-0 lg:pl-12 2xl:pl-24">
          ...
          <p className="text-gray-600 text-base lg:text-lg 2xl:text-xl mb-6">
            At Starc, we are driven by a commitment to excellence, integrity,
      ...
      <section className="py-20 bg-white flex  justify-center ">
        ...
        <div className=" w-[40%] pt-10 pl-20">
          ...
          <div className="flex justify-around">
            <div className="text-center">
              <div className="text-4xl font-mont font-bold bg-gradient-to-r from-[#6E51E0] to-[#8A63FFB2] bg-clip-text text-transparent">
                200+
              </div>
        ...
        <div className="w-[40%] px-10">
          ...
          <p className="text-lg text-gray-600  font-mont leading-relaxed">
            ...
            encouraged to reach their full potential. Join our vibrant community
            and become part of a network committed to continuous growth and
            success.
          </p>
        </div>
        {/* </div> */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col items-start space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Ensure our curriculum remains cutting-edge, incorporating the
                  latest trends to keep learners competitive.
                </p>
              </div>
            </div>
          </div>
