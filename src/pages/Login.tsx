            ...
            <style>
              {`
                ...
                @media (min-width: 1920px) {
                  .large-screen\\:pb-\\[60\\%\\] {
                    padding-bottom: 60%; /* Slightly reduced padding-bottom for vector image container */
                  }
                  .large-screen\\:pl-14 {
                    padding-left: 3.5rem; /* Adjusted padding for vector image container */
                  }
                  .large-screen\\:pl-32 {
                    padding-left: 8rem; /* Adjusted padding for vector image */
                  }
                  /* Increase the maxWidth of the Vector image */
                  vector {
                    max-width: 1000px !important; /* Increased from 800px to 1000px for 1920px screens */
                  }
                }
              `}
            </style>
